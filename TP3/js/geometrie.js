...
function traceCourbePara(nb,CoulHexa,epai){
    ...
    let line = new THREE.Line(new THREE.BufferGeometry().setFromPoints(points), new THREE.LineBasicMaterial({color:CoulHexa, linewidth: epai}));
    return line;
}